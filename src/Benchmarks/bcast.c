...
void main_bcast(int argc, char *argv[]) {
    ...
    while(j<=4194304) {
        ...
        char *msg1 = (char *) malloc(sizeof(char) * j);
        ...
        for (k = 0; k < 2; k++) {
            ...
            for (i = 0; i < n_sample; i++) {
                MPI_Bcast(msg1, j, MPI_BYTE, i % size, MPI_COMM_WORLD);
            }
...
//#ifndef INCLUDE_MAIN
//#define INCLUDE_MAIN
//void main(int argc, char **argv) {main_bcast(argc, argv);}
//#endif